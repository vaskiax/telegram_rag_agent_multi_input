...
This project is a high-performance **Cognitive Agent** designed to ingest complex Physics/Math content (mostly PDFs) and teach it to users with the persona of a charismatic Professor. 
